...
Button 1: moves black paddle down
Button 2: moves black paddle up
Button 3: moves red paddle down
Button 4: moves red paddle up

You are able to view the displayed score on the screen as well as a marker that labels what player is playing on what side.
